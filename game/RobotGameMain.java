...
public class RobotGameMain {
    ...
    private static class CommandManager {
        ...
        private void initChangeDirHandler() {
            handlers.add(new CommandHandler() {
                @Override
                public String name() {
                    return "changedir";
                ...
                public void runCommand(String[] args) {
                    ...
                    if (robot.isPresent() && dir.isPresent()) {
                        ...
                        System.out.println(
                                "Робот " + robotId + " сменил направление на " + args[1]);
                    } else if (dir.isEmpty()) {
                        System.out.println("Неверное направление. Введите TOP, RIGHT, BOTTOM, LEFT");
                    } else {
            ...
            handlers.add(new CommandHandler() {
                ...
                public void runCommand(String[] args) {
                    ...
                    if (map.delete(robotId)) {
                        System.out.println("Робот " + robotId + " был удален");
                    } else {
                        System.out.println("Робот " + robotId + " не найден");
                    }
                }
